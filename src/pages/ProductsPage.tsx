      ...
      <div className="container px-4 mx-auto py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-bicolartistry-600 dark:text-bicolartistry-300 max-w-2xl mx-auto">
            Discover authentic handcrafted treasures that showcase the rich
            cultural heritage and artistic tradition of the Bicol region.
          </p>
        </div>
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            <div className="relative w-full md:w-auto flex-1 max-w-md">
              <Search
                size={18}
                className="absolute left-3 top-1/2 transform -translate-y-1/2 text-bicolartistry-400"
              />
              <Input
                type="text"
